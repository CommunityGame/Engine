...
Vec2d			Input::getWindowCenter( void ) const
{
	return ( Vec2d( this->_window->getWidth() / 2.0, this->_window->getHeight() / 2.0 ) );
}
...
{
	glfwSetInputMode( this->_window->getGLFWwindow(), GLFW_CURSOR, visible ? GLFW_CURSOR_NORMAL : GLFW_CURSOR_DISABLED );
}
